...
public class VectorHelper {
	...
	/**
	* Ensures for supplied start and end instances that xyz are smaller on the start object. Returns both as an ArrayList with start beeing the first element
	* Very important for Iterating from start to end without changing the loop operation to either increment or decrement the loop counter
	* start: Vector3 instance representing the start
	* end: Vector3 instance representing the end
	*/
	...
	/**
	* Returns only true if all values from start are smaller than all values from end
	*/
